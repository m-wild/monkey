...
func TestBangOpeator(t *testing.T) {
	tests := []struct {
		input    string
		expected bool
	}{
...
func TestReturnStatements(t *testing.T) {
	tests := []struct {
		...
		{"return 2 * 5; 9;", 10},
		{"9; return 2 * 5; 9;", 10},
		{"if (true) { if (true) { return 10; } return 5; }", 10},
	}
...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if integer.Value != expected {
		t.Errorf("integer has wrong value. got=%d, want=%d", integer.Value, expected)
		return false
	}
	return true
}
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if boolean.Value != expected {
		t.Errorf("boolean has wrong value. got=%t, want=%t", boolean.Value, expected)
		return false
	}
	return true
}
